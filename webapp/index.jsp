...
<body style="background-image: url('https://raw.githubusercontent.com/dakshatakv/basic-banking-system/main/bg.PNG'); background-repeat: no-repeat; background-size: cover;">
